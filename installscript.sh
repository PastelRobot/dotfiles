...
sudo pacman -S polkit xfce4-power-manager clipit ncurses steam lutris dunst discord dolphin ttf-liberation pulseaudio pulseaudio-alsa pulseaudio-bluetooth pulseaudio-jack
